{\color{bleu}\chapter{Présentation du Contexte}}
\thispagestyle{empty}
\newpage
...
{\color{bleu} \section{Présentation de Sonatrach}}
...
{\color{bleu} \section{Infrastructure Existante et Contexte Technologique}}

{\color{bleuu} \subsection{Infrastructure actuelle de Sonatrach}}
...
{\color{bleuu} \subsection{Les besoins en infrastructure légère pour les zones de test}}
...
{\color{bleu} \section{Problématique}}
...
{\color{bleu} \section{Objectifs du Projet}}

{\color{bleuu} \subsection{Objectif général}}
...
{\color{bleuu} \subsection{Objectifs spécifiques}}
...
{\color{bleu} \section{Périmètre et Limitations du Projet}}
