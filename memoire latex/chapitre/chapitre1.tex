...
\par Sonatrach joue également un rôle clé dans la stratégie énergétique de l’Algérie en matière de sécurité énergétique, de transition vers une économie plus durable, et de développement de nouveaux secteurs tels que le gaz naturel liquéfié (GNL), le gaz de schiste et les énergies renouvelables. \\

\par Aujourd’hui, Sonatrach est un acteur majeur sur la scène énergétique mondiale, avec une présence dans plusieurs pays et une forte contribution aux exportations algériennes. Elle continue d’innover et de s’adapter aux enjeux géopolitiques et environnementaux afin de maintenir sa place dans un marché énergétique en constante évolution~\cite{ref1}.\\
...
\par Le projet est réalisé au sein du Data Center de la Direction Centrale Recherche et Développement (DC R&D) de Sonatrach. Cette direction joue un rôle stratégique dans l’innovation technologique et l’optimisation des processus liés à l’exploration et la production. Elle dispose d’infrastructures informatiques avancées, notamment des clusters de calcul et des solutions de stockage haute capacité, destinées à soutenir les travaux de simulation et de traitement sismique. C’est dans ce cadre que s’inscrit notre projet, avec pour objectif de renforcer les capacités de calcul et d’améliorer l’efficacité du traitement sismique grâce à une architecture HPC performante.\\
...
\par Sonatrach dispose actuellement d'une infrastructure hyperconvergée reposant sur deux solutions propriétaires complémentaires : Nutanix et VMware vSAN. Nutanix, déployé à l'échelle nationale sur plusieurs wilayas, équipe les infrastructures de grande envergure et les environnements de production critiques, tandis que VMware vSAN est privilégié pour les déploiements de plus petite taille. Ces deux solutions sont reconnues pour leur stabilité, leurs performances et la richesse de leurs fonctionnalités, notamment en matière de gestion centralisée, de haute disponibilité et de scalabilité.\\
