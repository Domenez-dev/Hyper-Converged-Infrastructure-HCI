{\color{bleu}\chapter{État de l'Art et Concepts Théoriques}}
\thispagestyle{empty}
\newpage
...
{\color{bleu} \section{L'Hyperconvergence (HCI)}}

{\color{bleuu} \subsection{Définition}}
...
{\color{bleuu} \subsection{Avantages de l'hyperconvergence}}
...
{\color{bleuu} \subsection{HCI vs Infrastructure Traditionnelle}}
...
{\color{bleu} \section{Comparaison : Solutions Propriétaires vs Open Source}}

{\color{bleuu} \subsection{Solutions propriétaires}}
...
{\color{bleuu} \subsection{Solutions open source}}
...
{\color{bleu} \section{Analyse des Solutions Open Source HCI}}
...
{\color{bleuu} \subsection{OpenStack}}
...
{\color{bleuu} \subsection{Harvester HCI}}
...
{\color{bleuu} \subsection{Proxmox VE}}
...
{\color{bleuu} \subsection{Tableau comparatif}}
...
{\color{bleu} \section{Présentation des Technologies Retenues}}

{\color{bleuu} \subsection{Proxmox VE : L'hyperviseur}}
...
{\color{bleuu} \subsection{Ceph : Le stockage distribué}}
...
{\color{bleuu} \subsection{Open vSwitch (OVS) : La virtualisation réseau}}
...
{\color{bleu} \section{Déploiement sur Infrastructure Physique Distribuée}}
