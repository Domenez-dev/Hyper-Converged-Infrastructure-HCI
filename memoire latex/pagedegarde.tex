...
\begin{titlepage}
	\thispagestyle{empty}
    \framethispage[1.5cm]% le cadre est à 1.5 cm des bords de la feuille
   ...
   \begin{center}	
   	...
   	\textbf{\normalsize Faculté d’Electronique et d’Informatique}\\[0.8cm]
   	\textbf{\large Département Informatique}\\[0.8cm]
...
\vfill
	\begin{center} 
		\normalfont{\textbf{\normalsize Soutenu le :  ../../2026  }} \\[0.3cm]
