...
\bibitem{ref18} Broadcom, « VMware DRS Overview: Optimizing Resource Allocation in vSphere Cluster », Broadcom Knowledge Base. [En ligne]. Disponible : \url{https://knowledge.broadcom.com/external/article/391137/vmware-drs-overview-optimizing-resource.html}
...
\bibitem{refVXLAN} % À COMPLÉTER : RFC 7348 VXLAN ou documentation OVS VXLAN
M. Mahalingam et al., « Virtual eXtensible Local Area Network (VXLAN): A Framework for Overlaying Virtualized Layer 2 Networks over Layer 3 Networks », RFC 7348, IETF, août 2014. [En ligne]. Disponible : \url{https://datatracker.ietf.org/doc/html/rfc7348}
